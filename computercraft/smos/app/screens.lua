...
function screens.alarms(state)
    ...
    local audioStatus = clipText(runtime.audioLastResult(state), 26)
    ...
    if ui.isLargeLayout() then
        ...
        ui.writeAt(8, top + 14, "Audio: " .. clipText(runtime.audioLastResult(state), 33), theme.muted, theme.panel)
