...
local alarmSounds = {
    { name = "minecraft:block.note_block.basedrum", pitch = 0.9 },
    { name = "minecraft:block.note_block.didgeridoo", pitch = 1.0 },
    { name = "minecraft:block.note_block.bell", pitch = 1.15 },
    { name = "minecraft:block.note_block.basedrum", pitch = 0.75 },
}
