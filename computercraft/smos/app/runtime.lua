...
local alarmNotes = {
    {
        siren = {
            { instrument = "bit", pitch = 3, volume = 1 },
            { instrument = "bit", pitch = 8, volume = 3 },
            { instrument = "bit", pitch = 15, volume = 2 },
        },
    },
    {
        siren = {
            { instrument = "bit", pitch = 6, volume = 1 },
            { instrument = "bit", pitch = 11, volume = 3 },
            { instrument = "bit", pitch = 18, volume = 2 },
        },
    },
    {
        siren = {
            { instrument = "bit", pitch = 9, volume = 1 },
            { instrument = "bit", pitch = 14, volume = 3 },
            { instrument = "bit", pitch = 21, volume = 2 },
        },
    },
    {
        siren = {
            { instrument = "bit", pitch = 12, volume = 1 },
            { instrument = "bit", pitch = 17, volume = 3 },
            { instrument = "bit", pitch = 24, volume = 2 },
        },
    },
    {
        siren = {
    ...
    },
    {
        siren = {
            { instrument = "bit", pitch = 6, volume = 1 },
            { instrument = "bit", pitch = 13, volume = 3 },
            { instrument = "bit", pitch = 20, volume = 2 },
        },
    },
}
